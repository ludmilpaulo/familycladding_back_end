...
from .views import (ImageListCreateAPIView, ImageRetrieveUpdateDestroyAPIView,
                    ...
                    TestimonialRetrieveUpdateDestroyAPIView,
...
urlpatterns = [
    ...
    path('testimonials/<int:pk>/', TestimonialRetrieveUpdateDestroyAPIView.as_view(), name='testimonial-retrieve-update-destroy'),
]
